...
const ChatSection = ({ user, canSendMessage, onSendMessage, messageLimit, onUpgradeClick }: ChatSectionProps) => {
  const getWelcomeMessage = () => {
    if (user.role === 'admin') {
      return 'Добро пожаловать, Администратор!\n\nБезлимитный доступ ко всем возможностям:\n• Полные ответы на любые вопросы\n• Автоматическое написание докладов\n• Объяснение теорий и концепций\n• Решение задач без уточнений\n• Поиск информации в интернете';
    }
    if (user.hasPro) {
      return 'Добро пожаловать, PRO пользователь!\n\nБезлимитные возможности:\n• Готовые доклады и сочинения\n• Объяснение любых теорий\n• Решение всех задач\n• Определения и термины\n• Поиск в интернете';
    }
    if (user.role === 'user') {
      return 'Добро пожаловать! (5 бесплатных запросов)\n\nПросто спросите - я сразу отвечу:\n• "Напиши доклад о..." → готовый текст\n• "Что такое..." → полное определение\n• "Объясни..." → понятное объяснение\n• "Реши..." → готовое решение';
    }
    return 'Привет! Я AI-помощник (5 запросов бесплатно)\n\nЗадавайте вопросы - отвечу сразу:\n✓ Доклады → готовый текст\n✓ Определения → полный ответ\n✓ Теории → понятное объяснение\n✓ Задачи → готовое решение';
  };
